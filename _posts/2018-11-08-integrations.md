...
Support, product updates, year licence, installations... all of this required a big budget to implement, now in your hands for $49,99

Think gmail or any other email provider for business. You get an awesome and otherwise very expensive product and service for a monthly fee, and you don't have to worry about updates, hardware, maintainance, etc... Some examples of what a company might choose:

- Freshbooks for accounting
- Salesforce as a CRM
- Shopify for web ecommerce
- MailChimp for marketing
- Wordpress for the webpage
- Cisco Webex for video meetings

This list grows and goes to different segments according to your industry. Gym Owner? Maybe you have something like VirtuaGym. Learning a language? maybe you are paying a monthly fee to memrise. 

But, as a small buisiness grows, and grows on top of different SaaS software, the typycal problem of integration arises. You're users demand better service, better service means better information, and to do that you need to integrate it. You have offcourse some systems that are now SaaS and in the cloud.
